...
<html lang="en">
	<head>
		...
		<!-- <script type="text/javascript" src="https://github.com/imhvost/chart-utils/blob/master/dist/chart-utils.min.js"></script> -->
	</head>
	<body>
					...
					<ul class="navbar-nav navbar-nav-right">
						<li class="nav-item  dropdown d-none d-md-block">
							...
							<div class="dropdown-menu navbar-dropdown" aria-labelledby="reportDropdown">
								...
								<a class="dropdown-item" href="#">
									<i class="mdi mdi-file-excel me-2">
									</i>
									Excel
								</a>
								<div class="dropdown-divider">
								...
								<a class="dropdown-item" href="#">
									<i class="mdi mdi-file-word me-2">
									</i>
									doc
								</a>
							</div>
						...
						<li class="nav-item  dropdown d-none d-md-block">
							...
							<div class="dropdown-menu navbar-dropdown" aria-labelledby="projectDropdown">
								<a class="dropdown-item" href="#">
									<i class="mdi mdi-eye-outline me-2">
									</i>
									View Project
								</a>
								<div class="dropdown-divider">
								...
								<a class="dropdown-item" href="#">
									<i class="mdi mdi-pencil-outline me-2">
									</i>
									Edit Project
								</a>
							</div>
						...
						<li class="nav-item nav-language dropdown d-none d-md-block">
							<a class="nav-link dropdown-toggle" id="languageDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
								<div class="nav-language-icon">
									<i class="flag-icon flag-icon-us" title="us" id="us">
									</i>
								</div>
							...
							<div class="dropdown-menu navbar-dropdown" aria-labelledby="languageDropdown">
								<a class="dropdown-item" href="#">
									<div class="nav-language-icon me-2">
										<i class="flag-icon flag-icon-ae" title="ae" id="ae">
										</i>
									</div>
									<div class="nav-language-text">
										<p class="mb-1 text-black">
								...
								<a class="dropdown-item" href="#">
									<div class="nav-language-icon me-2">
										<i class="flag-icon flag-icon-gb" title="GB" id="gb">
										</i>
									</div>
									<div class="nav-language-text">
										<p class="mb-1 text-black">
								...
								<div class="p-2">
									...
									<a class="dropdown-item py-1 d-flex align-items-center justify-content-between" href="#">
										...
										<span class="p-0">
											...
											<i class="mdi mdi-email-open-outline ms-1">
											</i>
										</span>
									</a>
									<a class="dropdown-item py-1 d-flex align-items-center justify-content-between" href="#">
										...
										<span class="p-0">
											...
											<i class="mdi mdi-account-outline ms-1">
											</i>
										</span>
									</a>
						...
						<li class="nav-item dropdown">
							<a class="nav-link count-indicator dropdown-toggle" id="messageDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<span class="count-symbol bg-success">
								</span>
							</a>
					...
					<ul class="nav">
						...
						<li class="nav-item">
							<a class="nav-link" href="./index.html">
								<span class="icon-bg">
									<i class="mdi mdi-cube menu-icon">
									</i>
								</span>
						...
						<li class="nav-item">
							<a class="nav-link" data-bs-toggle="collapse" href="#auth" aria-expanded="false" aria-controls="auth">
								<span class="icon-bg">
									<i class="mdi mdi-lock menu-icon">
									</i>
								</span>
								<span class="menu-title">
									User Pages
						...
						<li class="nav-item sidebar-user-actions">
							<div class="sidebar-user-menu">
								<a href="#" class="nav-link">
									<i class="mdi mdi-speedometer menu-icon">
									</i>
									<span class="menu-title">
										Take Tour
									</span>
						...
						<li class="nav-item sidebar-user-actions">
							<div class="sidebar-user-menu">
								<a href="#" class="nav-link">
									<i class="mdi mdi-logout menu-icon">
									</i>
									<span class="menu-title">
										Log Out
									</span>
				...
				<div class="main-panel">
					<div class="content-wrapper">
						<div class="w3-container">
							<p>
								Lorem, ipsum dolor sit amet consectetur adipisicing, elit. Id, suscipit maiores ad eaque ratione, facilis libero ex tempora, alias magni aliquam assumenda. Obcaecati beatae vitae, quo tempore aliquid iste corrupti!
							</p>
						</div>
						<div class="w3-container">
							<div>
